...
function generateModernTemplate(resume: ResumeData, biography: string): string {
  ...
  <footer class="footer-modern">
    <div class="container">
      ...
      <p class="footer-credit">Portfolio gerado por <a href="https://resumai.davidsodre.com" target="_blank">ResumAI</a></p>
    </div>
  </footer>
`;
}
...
console.log('Portfolio loaded successfully! Generated by ResumAI');
`;
}
